...
import { PostCard, HandlerHoc } from '../components';
import { GET_USERS, GET_USERS_MOBILE, GET_POSTS_MOBILE } from '../services/graphql';
...
export const App: FC = () => {
  ...
  const { data: posts } = useQuery<{ posts?: Post[] }>(GET_POSTS_MOBILE, {
    variables: { id: '1' },
  });
  ...
  return (
    <HandlerHoc
      ...
      isLoading={loading}
      noData={!data?.users || data?.users?.length === 0}
      refetch={refetch}
    >
